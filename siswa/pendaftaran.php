...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    val_alpha($errors, 'alamat_siswa', $alamat_siswa, 'Alamat harus berupa huruf dan spasi.'); 

    val_required($errors, 'id_jurusan', $id_jurusan, 'Jurusan wajib dipilih.');
    val_numeric($errors, 'id_jurusan', $id_jurusan, 'Jurusan yang dipilih tidak valid.'); 
    ...
    val_alpha($errors, 'kebutuhan', $kebutuhan, 'Kebutuhan harus berupa huruf dan spasi.'); 
    ...
    val_alpha($errors, 'keadaan_ayah', $keadaan_ayah, 'Keadaan Ayah harus berupa huruf dan spasi.'); 

    val_required($errors, 'alamat_ayah', $alamat_ayah, 'Alamat Ayah wajib diisi.');
    val_alpha($errors, 'alamat_ayah', $alamat_ayah, 'Alamat Ayah harus berupa huruf dan spasi.'); 
    ...
    val_alpha($errors, 'keadaan_ibu', $keadaan_ibu, 'Keadaan Ibu harus berupa huruf dan spasi.'); 

    val_required($errors, 'alamat_ibu', $alamat_ibu, 'Alamat Ibu wajib diisi.');
    val_alpha($errors, 'alamat_ibu', $alamat_ibu, 'Alamat Ibu harus berupa huruf dan spasi.'); 
...
<div class="form_pendaftaran">
    ...
    <form method="POST" enctype="multipart/form-data" class="isi_pendaftaran">
        ...
        <div class="form_isi">
                ...
                <div class="radio-group-horizontal">
                    <input type="radio" id="masih_hidup" name="keadan_ayah" value="masih hidup">
                    <label for="masih hidup">Masih Hidup</label>
                    
                    <input type="radio" id="sudah_tidak_ada" name="keadan_ayah" value="sta">
                    <label for="sta">Sudah Tidak Ada</label>
                    <?php if(!empty($errors['keadan_ayah'])): ?>
            <span class="error"><?= $errors['keadan_ayah'] ?></span>
            <?php endif; ?>
                </div>
        </div>
        ...
        <div class="form_isi">
            <label for="">Keadaan Ibu :</label>
                <div class="radio-group-horizontal">
                    ...
                    <input type="radio" id="sudah_tidak_ada" name="kedaan_ibu" value="sta">
                    <label for="sta">Sudah Tidak Ada</label>
                    <?php if(!empty($errors['kedaan_ibu'])): ?>
            <span class="error"><?= $errors['kedaan_ibu'] ?></span>
            <?php endif; ?>
                </div>
        </div>
